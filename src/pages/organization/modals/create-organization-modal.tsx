...
import { CheckCircle2, Loader2, Minus, Plus, RefreshCw } from "lucide-react"
...
export function CreateOrganizationModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="grid max-h-[86vh] grid-rows-[auto_minmax(0,1fr)_auto] gap-0 overflow-hidden border-border bg-background p-0 shadow-lg sm:max-w-3xl sm:rounded-xl">
        <DialogHeader className="border-b border-border bg-background px-8 py-6">
          <div className="max-w-2xl">
            ...
            <DialogDescription className="text-sm text-muted-foreground">
              {createdTenant
                ? "Ready to Replicate Master Data"
                : existingOrganization
          ...
          <div className="p-6 md:p-8">
            {createdTenant ? (
              <div className="flex min-h-[360px] flex-col items-center justify-center px-4 py-12 text-center">
                <div className="mb-5 flex size-16 items-center justify-center rounded-full border border-emerald-500/20 bg-emerald-500/10 text-emerald-600">
                ...
                <p className="mt-2 max-w-md text-sm text-muted-foreground">
                  ...
                  is ready for master data replication in the tenant DB.
                </p>
                <div className="mt-6 w-full max-w-lg rounded-md border border-border bg-background p-4 text-left">
