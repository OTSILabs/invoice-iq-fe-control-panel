...
import { useNormalizationRule, useDeleteNormalizationRuleMutation } from "@/api/hooks/usenormalization-rules"
...
export function NormalizationRuleDetail() {
  ...
  return (
    <PageShell>
      <PageMetadata title="Normalization Rule Details" description="Configure formatting and normalization transformations." keywords="normalization rules, regex formatting" />
      {/* Header */}
      <PageHeader
