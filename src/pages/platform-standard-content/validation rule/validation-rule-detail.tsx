    ...
    <div className="flex w-full flex-col gap-6 pb-12 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="space-y-1">
          <h1 className="text-lg font-semibold tracking-tight text-foreground">Validation Rule Details</h1>
          <p className="text-xs text-muted-foreground">View details, target scopes, and schema configurations for this validation rule</p>
        </div>
