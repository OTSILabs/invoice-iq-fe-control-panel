    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="flex items-center gap-2.5 py-0.5">
          <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-md border border-primary/20 bg-primary/10 text-[10px] leading-none font-semibold text-primary">
            {getInitials(slug)}
          </div>
...
): CustomColumnDef<PlatformUser>[] => [
  {
    ...
    cell: ({ row }) => (
      <div className="flex items-center gap-3">
        <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-md border border-primary/20 bg-primary/10 text-[10px] leading-none font-semibold text-primary uppercase">
