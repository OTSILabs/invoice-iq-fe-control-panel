          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2 pt-1">
              ...
              <Input 
                ...
                disabled={isPending}
                className="h-11 font-mono rounded-xl bg-slate-50/50 border-slate-200 text-slate-900 placeholder:text-slate-400 focus-visible:bg-white focus-visible:ring-4 focus-visible:ring-blue-500/10 focus-visible:border-blue-500 transition-all duration-200"
              />
            </div>
