...
export const validationRuleSchema = z.object({
  rule_code: z
    ...
    .regex(/^[a-z0-9_]+$/, "Code must be lowercase alphanumeric with underscores (e.g. valid_email)"),
...
export type ValidationRuleFormValues = z.infer<typeof validationRuleSchema>

export const DEFAULT_VALIDATION_RULE_VALUES: ValidationRuleFormValues = {
  rule_code: "",
  display_label: "",
  description: "",
